...
const Hero4 = () => {
    return (
        <div className="h-screen">
            <section className="flex items-center relative bg-hero-pattern4 bg-no-repeat bg-cover h-screen">
                <div className="relative items-center w-full gap-12 p-8 mx-auto lg:inline-flex lg:p-20 max-w-7xl rounded-3xl lg:py-32">
                    <div className="max-w-4xl mx-auto text-center">
                        <div>
                            ...
                            <h1 class="animate-text bg-gradient-to-r from-[#EB03FF] via-[#FF0F9F] to-[#3A0D84] bg-clip-text text-transparent text-5xl font-black"> Cristian Peña</h1>
